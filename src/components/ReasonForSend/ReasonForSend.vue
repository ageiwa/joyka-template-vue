<script setup>
    ...
    const slides = ref([
        ...
        {img: 'src/assets/slider-img2.png', title: 'Пригласить друзей на вечеринку', subtitle: 'От приглашения, переданного <span class="item-slider__bold-text">лично в руки,</span> настрой хорошо повеселиться обеспечен'},
